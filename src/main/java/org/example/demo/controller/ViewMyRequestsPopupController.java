...
public class ViewMyRequestsPopupController {
    ...
    private void openApplyRemoteWorkWindow(LeaveRequest request) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/demo/views/apply_remote_work.fxml"));
    ...
    private void openModifyRequestWindow(LeaveRequest request) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/demo/views/modify_request.fxml"));
            VBox root = loader.load();
    ...
    private void openRemoteJobDetailsWindow(OnlineJob remoteJob) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/demo/views/remote_job_details.fxml"));
            VBox root = loader.load();
